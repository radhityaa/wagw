          ...
          <div class="ui fluid card">
            ...
            <div class="content body">
              ...
              <div class="step general" :class="{ active: stepIsActive(2) }">
                ...
                <p>Just skip :: via <a style="color:red;" href="https://vienapps.com/" target="_blank">Licensed By Vien
                    Apps</a></p>
                <div class="field">
            ...
            <div class="content footer ">
              <button class="ui d-none  large previeus button ml-0 mr-auto" @click="navigateSteps(-1)" type="button"
                :class="{ disabled: stepIsActive(1) }">{{ __('Previous') }}</button>
              <button class="ui large next button ml-auto mr-0" @click="navigateSteps(1)" type="button"
                v-if="step <= 3">{{ __('Next') }}</button>
